...
void main() async {
  ...
  try {
    ...
    try {
      final christmasSongs = await cacheManager.getCollectionWithRetry('lagu_krismas_26346');
    ...
    print('  Cached collections after clear: ${statsAfterClear['cached_collections']}');
