...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Future<void> _loadSettings() async {
    ...
    if (mounted) {
      setState(() {
        ...
        _fontFamily = _fontFamilies.contains(_prefsService.fontStyle)
            ? _prefsService.fontStyle
            : 'Roboto';
  ...
  Widget _buildFontSizeSlider() => ListTile(
  ...
  Widget _buildFontFamilySelector() => ListTile(
        contentPadding: EdgeInsets.zero,
  ...
  Widget _buildTextAlignmentSelector() => Column(
  ...
  Widget _buildDarkModeSwitch() => SwitchListTile(
