...
class _AnnouncementManagementPageState
  ...
  Future<void> _createAnnouncement() async {
    ...
    try {
      ...
      // ✅ NEW: Include customization data
      final announcement = Announcement(
        id: '', // Will be generated by service
        title: _titleController.text.trim(),
        content: _selectedType == 'text' ? _contentController.text.trim() : '',
        type: _selectedType,
        imageUrl: '', // Will be set by service if image
        isActive: true,
        priority: _priority,
        createdAt: DateTime.now(),
        createdBy: currentUser.email ?? 'Unknown',
        expiresAt: _expiresAt,
        // ✅ NEW: Add styling fields
  ...
  void _resetForm() {
    ...
    setState(() {
      ...
      _priority = 1;
      _expiresAt = null;
      // ✅ NEW: Reset customization fields
      ...
      body: CustomScrollView(
        slivers: [
          AdminHeader(
            ...
            subtitle:
                'Manage news, promotions & banners - Sort: ${_sortOrder.toUpperCase()}',
            icon: Icons.campaign,
                ...
                ColorPickerWidget(
                  ...
                  onColorSelected: (color) {
                    setState(() {
                      ...
                      _selectedBackgroundGradient = null; // Clear gradient
                    });
                  },
                ),
                const SizedBox(height: 16),
                ...
                GradientPickerWidget(
                  ...
                  onGradientSelected: (gradient) {
                    setState(() {
                      ...
                      _selectedBackgroundColor = null; // Clear solid color
                    });
                  },
                ),
                const SizedBox(height: 16),
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        icon: Icon(announcement.isActive
                            ? Icons.pause
                            : Icons.play_arrow),
                        label: Text(
